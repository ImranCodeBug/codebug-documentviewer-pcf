...
import { IMainContainerProps, MainContainerComponent } from "./MainContainerComponent";
...
export class DocumentViewer implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {        
        ...
        // const entityId = "fdsdfdsfsf";
        // const clientUrl = "https://your-org.crm.dynamics.com";

        const annotationService : IAnnotationService = new AnnotationService(context.webAPI);

        const props : IMainContainerProps = {
            entityId: entityId,            
            clientUrl: clientUrl,
